...
- Flags: `UI=true`
- APIs: `GET /v1/ui/home`, `GET /v1/ui/company/{ticker}`, `POST /v1/ui/search`, `GET /v1/ui/autocomplete`, `GET /v1/ui/article/{id}`, `GET /v1/ui/research/{id}`, `GET /v1/ui/theme/{id}`, `GET /v1/ui/sector/{id}`, `GET /v1/ui/timeline/{entity}`, `GET /v1/ui/predictions`, `GET /v1/ui/dashboard`, `GET /v1/ui/macro`, `GET /v1/ui/portfolio`, `GET /v1/ui/copilot`, `GET /v1/ui/workflow`, `GET /v1/ui/health`
