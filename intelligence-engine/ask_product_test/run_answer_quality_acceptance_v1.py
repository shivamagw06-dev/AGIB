...
def main() -> int:
    ...
    try:
        ...
        (ARTIFACTS / "answer_quality_acceptance_v1.json").write_text(
            json.dumps(report, indent=2, default=str), encoding="utf-8"
        )
        (ARTIFACTS / "answer_quality_acceptance_v1.md").write_text(_markdown(report), encoding="utf-8")
        (ARTIFACTS / "answer_quality_acceptance_v1.html").write_text(_html(report), encoding="utf-8")
    except Exception:
        pass
