"""Company IR adapter — lowest priority official source (FSE-02.3)."""

from __future__ import annotations

from typing import Any

from financial_statements_engine.collection.adapters.ir import discover_ir
...
class IrSourceAdapter:
    ...
    def health(self) -> dict[str, Any]:
        enabled = cfg.enable_ir()
        return {
            "status": "ok" if enabled else "disabled",
            "source_id": self.source_id,
            "enabled": enabled,
            "wraps": "collection.adapters.ir.discover_ir",
