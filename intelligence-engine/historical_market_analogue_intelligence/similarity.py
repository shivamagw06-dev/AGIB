"""Deterministic multi-dimension similarity scoring for market analogues."""
...
DIMENSION_SCALES: dict[str, float] = {
    "market_regime": 4.0,  # ordinal 0-10
    "breadth": 25.0,  # index points
    "liquidity": 25.0,
    "volatility": 30.0,
    "fii_flows": 30.0,
    "dii_flows": 25.0,
...
DIMENSION_LABELS: dict[str, str] = {
    ...
    "fii_flows": "Institutional Flows (FII)",
    "dii_flows": "Institutional Flows (DII)",
