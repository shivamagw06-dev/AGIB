...
_LENS: dict[str, tuple[str, tuple[str, ...], tuple[str, ...]]] = {
    "banks": ("pb", ("roe", "pe", "dividend_yield", "eps", "book_value"), ("ev_ebitda", "ev_sales", "ps")),
    ...
    "it_services": ("pe", ("roe", "profit_margin", "dividend_yield", "ev_ebitda"), ("pb",)),
    "software": ("ev_sales", ("pe", "profit_margin", "ps"), ("pb",)),
    "internet_platforms": ("ev_sales", ("ps", "profit_margin", "pe"), ("pb",)),
    "telecom": ("ev_ebitda", ("pe", "ps", "debt_to_equity"), ("pb",)),
    ...
    "airlines": ("ev_ebitda", ("ps", "debt_to_equity"), ("pb", "pe")),
    ...
    "capital_goods": ("pe", ("ev_ebitda", "roe", "profit_margin"), ()),
    ...
    "retail": ("ev_ebitda", ("pe", "ps", "profit_margin"), ()),
    "qsr": ("ev_ebitda", ("ps", "pe"), ("pb",)),
    "fmcg": ("pe", ("ev_ebitda", "roe", "dividend_yield", "profit_margin"), ()),
