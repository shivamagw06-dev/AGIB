...
**Sprint 6.1** acquisition · **6.2** IKO · **6.3** ILE · **6.4** KRIG · **6.5** AKO.
...
## Adaptive Knowledge Orchestrator (6.5)

Market sessions drive cadence. Earnings / RBI / Budget events temporarily boost polling. Overnight rebuilds run when users are quiet. Every scheduling decision is observable via Mission Control.
