  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-900 dark:to-zinc-800">
      <div className="max-w-md w-full p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-xl">
        <h1 className="text-2xl font-bold mb-2 text-center">Login / Sign Up</h1>
        <p className="text-sm text-zinc-500 text-center mb-6">Sign in to access the Content Studio</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            ...
            className="w-full rounded bg-blue-700 px-4 py-2 text-white font-semibold hover:bg-blue-800 disabled:opacity-50"
          >
