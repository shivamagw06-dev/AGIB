export const DEFAULT_CATEGORIES = [
  // Keep original DB-seeded names first so local fallback never violates articles_section_allowed.
  { name: 'Morning Market Update', slug: 'morning-market-update', description: 'AGI Morning Brief — pre-market and opening bell', sort_order: 1 },
